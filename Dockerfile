...
COPY ./gateway-app/target/gateway-app.jar /opt/xs2a-connector-examples/gateway-app.jar

EXPOSE 8089 8000

CMD exec $JAVA_HOME/bin/java $JAVA_OPTS -jar /opt/xs2a-connector-examples/gateway-app.jar
