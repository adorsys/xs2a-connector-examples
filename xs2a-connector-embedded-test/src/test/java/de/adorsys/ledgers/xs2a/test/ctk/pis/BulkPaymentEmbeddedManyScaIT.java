...
public class BulkPaymentEmbeddedManyScaIT {
    ...
    public void beforeClass() {
        PaymentCase paymentCase = LoadPayment.loadPayment(BulkPaymentEmbeddedManyScaIT.class, "BulkPaymentEmbeddedManyScaIT.yml", ymlMapper);
