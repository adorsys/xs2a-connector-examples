...
public class BulkPaymentEmbeddedOneScaMethodIT {
    ...
    public void beforeClass() {
        PaymentCase paymentCase = LoadPayment.loadPayment(BulkPaymentEmbeddedOneScaMethodIT.class, "SinglePaymentEmbeddedOneScaMethodIT.yml", ymlMapper);
