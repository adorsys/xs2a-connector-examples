...
public class LedgersDefaultPaymentValidatorHolder extends DefaultPaymentValidatorHolder {
    ...
    @Autowired
    public LedgersDefaultPaymentValidatorHolder(LedgersPaymentBodyFieldsValidatorImpl defaultPaymentBodyFieldsValidator,
                                                DefaultPaymentBusinessValidatorImpl defaultPaymentBusinessValidator) {
        super(defaultPaymentBodyFieldsValidator, defaultPaymentBusinessValidator);
    }
